...
const AboutPageStyles = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "about__AboutPageStyles"
})(["h1{margin-bottom:.667em;}.gatsby-image-wrapper.avatar-image{margin-bottom:2em;overflow:visible;&:after,&:before{content:'';z-index:2;position:absolute;display:block;background:", ";height:1em;}&:before{width:1em;left:.5em;top:-0.5em;}&:after{width:5em;left:6.25em;bottom:-0.5em;}img{background:", ";mix-blend-mode:hard-light;filter:saturate(0.5);}}.about-body{h1{font-size:1.75em;line-height:1.4;margin-bottom:.3em;}strong{color:", ";}}"], props => props.theme.accentColor, props => props.theme.accentColor, props => props.theme.accentColor);

const AboutPage = ({
  data
}) => {
  const aboutData = data.allStrapiAbout.nodes[0];
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(AboutPageStyles, {
    className: "container"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", {
    className: "page-header"
  }, "\xC0 propos"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_2__.GatsbyImage, {
    image: (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_2__.getImage)(aboutData.about_avatar.localFile.childImageSharp.gatsbyImageData),
    key: aboutData.about_avatar.localFile.id,
    alt: "\xC0 propos de Romain Mosser",
    ...
    children: aboutData.about_text.data.about_text
  })));
};

const query = "1020331895";
const Head = ({
  data
}) => {
